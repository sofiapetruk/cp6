...
export default function Linguagem({ date }: NasaComponentProps) {
  ...
  return (
    <div>
      <h1 className="font-arial text-2xl font-bold mb-4"> Linguagem e Semântica da Astronomia</h1>
      ...
      <div>
        {nasa ? (
          <figure className='flex flex-col items-center'>
            ...
            <Link href={`/Linguagem/ling/${nasa.date}`} className='bg-blue-700 p-4 rounded-lg text-white mt-10 text-2xl'>Ver Mais</Link>
          </figure>
        ) : (
          <p>Carregando...</p>
        )}
